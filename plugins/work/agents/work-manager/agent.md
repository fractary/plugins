...
name: work-manager
type: agent
description: 'Universal work tracking agent - routes work item operations to specialized
  skills across

  GitHub Issues, Jira, and Linear. Provides decision logic and routing for ALL work
  tracking
