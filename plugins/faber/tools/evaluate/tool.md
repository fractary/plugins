...
name: evaluate
type: tool
description: 'FABER Phase 4 - Evaluate skill responsible for validation, testing,
  quality assurance,
...
implementation:
  ...
  execution_pattern: "The evaluate skill follows a skill-based execution pattern:\n\
    ...
    \ structured result with validation details\n4. If validation fails and retries\
    \ remain, workflow returns to Build phase\n"
