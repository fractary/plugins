...
name: release
type: tool
description: 'FABER Phase 5 - Release skill responsible for creating pull requests,
  deploying,
...
implementation:
  ...
  execution_pattern: "The release skill follows a skill-based execution pattern:\n\
    ...
    \ with PR details and release information\n4. Requires user approval for destructive\
    \ operations (merge, close)\n"
