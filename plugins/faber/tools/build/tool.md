...
name: build
type: tool
description: 'FABER Phase 3 - Build skill responsible for implementation, code generation,
  testing,
...
implementation:
  ...
  execution_pattern: "The build skill follows a skill-based execution pattern:\n1.\
    ...
    \ implementation details\n4. May be invoked multiple times in Build-Evaluate retry\
    \ loop\n"
